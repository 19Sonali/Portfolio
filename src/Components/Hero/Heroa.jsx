  ...
  return (
    ...
    <section className='hero-container'>
        <div className='hero-content'>
            ...
            <p >A Computer Science and Business Systems student from St Joseph Engineering College.With a keen interest in web development, I am passionate about creating dynamic and user-friendly websites.</p>
            ...
            <a href="./Resume.pdf" className='cv-btn' download>Download Resume</a>
        </div>
